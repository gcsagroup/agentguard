...
本次 M0／M1 原始碼整合新增受保護本機 Agent：模型資料授權、隔離副本、命令與差異批准、實際回寫、持久稽核和專用瀏覽器統一工作階段。Ver 1.0（010）已有後台與原生逐項驗收記錄；F13 依使用者要求暫緩；[F14 Docker 虛擬鏈路（簡體）](docs/agd-f14-docker-network-2026-09-14.zh.md)已通過，AGD-014 來源標記開發中。完整原 M1 未通過。見[開發計畫（簡體）](docs/agentguard-development-plan-2026-09-09.zh.md)、[010 驗收（簡體）](docs/agd-m1-pending-draft-010-2026-09-11.zh.md)與[原始碼整合記錄（簡體）](docs/agentguard-source-merge-2026-09-14.zh.md)。
