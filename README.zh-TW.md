...
**整個計畫仍未完成。** 2026-09-22 已把 Chrome 候選 ZIP 的 B1／B2／B3／B5 做實（B4 N/A，Edge 缺失），桌面明確注入會停住同一工作階段閘道，主動防護頁區分三條路徑；見[主動防禦第一波（簡體）](docs/agd-active-defense-2026-09-22.zh.md)。AGD-027 已依使用者同意的新口徑關閉：原生讀取 p95 ≤20 ms，首次啟動只記錄，見[口徑拆分（簡體）](docs/agd-027-budget-split-2026-09-22.zh.md)；原 100 ms 失敗保留。F13 依使用者要求暫緩、未驗收；AGD-031 已完成本機 STIX 往返，尚未外發；AGD-032 仍待正式發佈材料。最新工作狀態與逐項證據以[開發計畫（簡體）](docs/agentguard-development-plan-2026-09-09.zh.md)為準，不用早期 010 或後續單項通過代替完整 M1 或發佈結論。
