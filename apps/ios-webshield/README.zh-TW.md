...
**1.0.0 (34)**。建置 33 的準確 CI 為 12 項成功／1 項失敗，繁中仍有無法定位的文字辨識報告。建置 34 將文字辨識獨立到其它審計之前，並記錄階段樹、截圖與報告類型；全部類別及未知報告失敗條件保持。

本機標準淺色完整檢查通過：Node 26／26、Swift 26／26、嚴格 Release、Analyze 與儲存庫 23／23。深色及最大字級補充回歸進行中，舊系統修復待新提交 CI；I6 與發布門檻未通過。 [記錄](../../docs/ios-ci-audit-2026-09-17.zh.md)。
