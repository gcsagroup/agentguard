...
[2026-09-23 原始碼整合、驗證與分支恢復說明（簡體）](source-integration-cleanup-2026-09-23.zh.md) — 本機僅保留 main；歸檔保留歷史失敗證據，發佈仍為 No-Go。

本入口提供三語導覽。目前三語覆蓋根 README、本入口、`1.0.0-rc.1` 發佈說明、CHANGELOG、隱私說明、各元件 README、主要商店文案，以及本輪維護的技術說明與驗收文件；其餘深層技術與稽核文件保留原始語言，並在下方標明用途與狀態。

> `1.0.0-rc.1` 是原始碼候選版。程式碼簽署、公證、商店發佈與真實裝置端對端驗收證據尚未完成，正式環境發佈判斷仍為 **No-Go**。

[主動防禦第一波（簡體，2026-09-22）](agd-active-defense-2026-09-22.zh.md) — Chrome 候選 ZIP 的 B1／B2／B3／B5、桌面高風險停閘道、AUTH／EGRESS／MEMORY 入口核對；不是商店或發佈通過。

[M0／M1 原始碼整合與驗證記錄（簡體，2026-09-14）](agentguard-source-merge-2026-09-14.zh.md)

- [AGD-015 原始內容、可見內容與檢測視圖（簡體）](agd-015-content-views-2026-09-14.zh.md) — 三類入口、Docker 43 項及真實 Chromium 內容驗收。
- [AGD-016 工具登記與變更複核（簡體）](agd-016-tool-registry-2026-09-15.zh.md) — 獨立複核、包凍結、71 項真實宿主檢查及 62 條稽核驗鏈。
...
- [郵件聯合防護設計（簡體）](mail-protection-design.md) · [繁體](mail-protection-design.zh-TW.md) · [English](mail-protection-design.en.md) — 已實作預設關閉的實驗性網頁信箱模組；代理仍為設計候選，真實信箱尚未驗收。
