...
[2026-09-23 源码整合、验证与分支恢复说明](source-integration-cleanup-2026-09-23.zh.md) — 本地仅保留 main；归档保留历史失败证据，发布仍为 No-Go。
...
[主动防御第一波（简体，2026-09-22）](agd-active-defense-2026-09-22.zh.md) — Chrome 候选 ZIP 的 B1／B2／B3／B5、桌面高风险停网关、AUTH／EGRESS／MEMORY 入口核对；不是商店或发布通过。
...
- [AGD-017 有限第三方 MCP 代理接续](agd-017-mcp-proxy-2026-09-15.zh.md) — 进行中：stdio 组件已实测，产品代理接线及远程验收尚未交付。
