...
The fixed development app is **AgentGuard Local Agent Test, Ver 2.1 (022)**. Activity entries display timestamps, and passive observations of ordinary installation instructions and input fields no longer produce those false alerts. The [022 native record](docs/native-form-observation-022-2026-09-16.zh.md) and [window-read recovery record](docs/native-ax-recovery-022-2026-09-16.zh.md) define the exact candidate and tested scope. Its name, path, Bundle ID, and signing identity remain fixed; version numbers are not added to the filename.
