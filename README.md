...
本次 M0／M1 源码整合新增受保护本地 Agent：模型数据授权、隔离副本、命令及差异批准、实际回写、持久审计和专用浏览器统一会话。Ver 1.0（010）已有后台与原生逐项验收记录；F13 按用户要求暂缓；[F14 Docker 虚拟链路](docs/agd-f14-docker-network-2026-09-14.zh.md)已通过，AGD-014 来源标记开发中。完整原 M1 未通过。见[开发计划](docs/agentguard-development-plan-2026-09-09.zh.md)、[010 验收](docs/agd-m1-pending-draft-010-2026-09-11.zh.md)和[源码整合记录](docs/agentguard-source-merge-2026-09-14.zh.md)。
